...
export default function ArchiveCourse({product, isActive, fetchData}) {
    ...
    return(
        <>
            {isActive 
                ?
                <Button variant="danger" className="m-2" size="sm" onClick={() => archiveToggle(product)}>Archive</Button>
                :
                <Button variant="success" className="m-2" size="sm" onClick={() => activateToggle(product)}>Activate</Button>
